...
const Menu = ({postId,uid}) => {
  ...
  return (
    <div className="absolute top-0 right-8 flex flex-col md:w-40 sm:w-32 w-24 px-1 md:px-2 py-2.5 bg-slate-600 gap-1.5 rounded-md border border-slate-300 shadow-md shadow-white/20" >
      <button onClick={()=>changeRoute(`/home/post/${postId}`)} className="py-1 md:text-md text-xs text-slate-200 font-semibold bg-slate-800 hover:bg-slate-900 rounded-md border hover:scale-105 transition-all duration-300" name="view btn">View Post</button>
