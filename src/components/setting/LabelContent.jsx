...
const LabelContent = ({content, length, edit}) => {
  ...
  return (
    <div className="bg-gray-900 w-auto flex items-center gap-3 lg:pl-5 pl-2 lg:pr-3 pr-0.5 py-1.5 border border-slate-100 rounded-md shadow-white/15 shadow-lg">
